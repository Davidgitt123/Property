                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center lg:text-left">
                            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-light mb-6">
                                ...
                                <span className="block text-primary mt-2">{t.heroTitle2}</span>
                            </h1>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                            Meet the talented team behind KamProperty - Working together to revolutionize property management
                        </p>
                        <div className="mt-4 text-primary font-semibold">
                            {language === 'en' ? 'Year 4 - Computer Science' : 'ឆ្នាំទី៤ - វិទ្យាសាស្ត្រកុំព្យូទ័រ'}
                        </div>
                    </div>
                                ...
                                <div className="flex flex-col items-center text-center">
                                    <div className="mb-6 relative">
                                        ...
                                        <div className="w-36 h-36 rounded-full overflow-hidden border-4 border-primary mx-auto">
                                            <img
                                                src={member.image}
                                                alt={language === 'en' ? member.enName : member.khName}
                                    ...
                                    <h3 className="text-xl font-bold text-light mb-1">
                                        {language === 'en' ? member.enName : member.khName}
                                    </h3>
                                    
                                    {/* Show both names on hover */}
                                    <div className="text-sm text-gray-400 mb-3">
                                        {language === 'en' ? member.khName : member.enName}
                                    </div>
                    ...
                    <div className="mt-16 grid grid-cols-1 md:grid-cols-4 gap-6">
                        <div className="bg-dark/30 backdrop-blur-sm rounded-xl p-6 text-center border border-gray-700">
                            ...
                            <div className="text-light font-medium">Team Members</div>
                            <div className="text-gray-400 text-sm mt-1">សមាជិកក្រុម</div>
                        </div>
                        <div className="bg-dark/30 backdrop-blur-sm rounded-xl p-6 text-center border border-gray-700">
                            <div className="text-3xl font-bold text-primary mb-2">4</div>
                            <div className="text-light font-medium">Developers</div>
                            <div className="text-gray-400 text-sm mt-1">អ្នកអភិវឌ្ឍន៍</div>
                        </div>
                        <div className="bg-dark/30 backdrop-blur-sm rounded-xl p-6 text-center border border-gray-700">
                            <div className="text-3xl font-bold text-primary mb-2">2</div>
                            <div className="text-light font-medium">Specialists</div>
                            <div className="text-gray-400 text-sm mt-1">អ្នកជំនាញ</div>
                        </div>
                        <div className="bg-dark/30 backdrop-blur-sm rounded-xl p-6 text-center border border-gray-700">
                            <div className="text-3xl font-bold text-primary mb-2">100%</div>
                            <div className="text-light font-medium">Dedication</div>
                            <div className="text-gray-400 text-sm mt-1">ការប្តេជ្ញាចិត្ត</div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="mt-16">
                        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-4">
                            <div className="text-center">
                                ...
                                <h3 className="text-lg font-medium text-dark">{t.feature1Title}</h3>
                            ...
                            <div className="text-center">
                                ...
                                <h3 className="text-lg font-medium text-dark">{t.feature2Title}</h3>
                                <p className="mt-2 text-base text-gray-600">
                                    {t.feature2Desc}
                                </p>
                            </div>
                            ...
                            <div className="text-center">
                                ...
                                <h3 className="text-lg font-medium text-dark">{t.feature3Title}</h3>
                                <p className="mt-2 text-base text-gray-600">
                                    {t.feature3Desc}
                                </p>
                            </div>
                            ...
                            <div className="text-center">
                                ...
                                <h3 className="text-lg font-medium text-dark">{t.feature4Title}</h3>
                                <p className="mt-2 text-base text-gray-600">
                                    {t.feature4Desc}
                                </p>
                            </div>
